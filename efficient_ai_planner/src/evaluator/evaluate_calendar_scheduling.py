...
_DATA_PATH = flags.DEFINE_string(
    'data_path',
    '/Users/niall.taylor/Documents/github_repos/nialls_repos/Agent_Projects/Efficient_AI_Planner/efficient_ai_planner/src/data/data/output_data_eval/eval_calendar.json',
